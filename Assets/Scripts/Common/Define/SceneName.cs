...
public class SceneName
{
    ...
    public static string MONSTER = "MonsterScene";
    ...
    public static string PARTY = "PartyScene";
    public static string[] HOME_GROUP = new string[] { HOME, BATTLE_MAP, MONSTER, MONSTER_LIST, ITEM_LIST, SHOP, OPTION, PARTY };
